...
```toml
[dependencies]
captcha-solvers = { git = "https://github.com/rlgrpe/captcha-solvers.git", tag = "v0.1.0" }
```
...
```toml
[dependencies]
captcha-solvers = { git = "https://github.com/rlgrpe/captcha-solvers.git", tag = "v0.1.0", default-features = false, features = ["capsolver"] }
```
